    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Monitor tank refill alerts and thresholds
        </p>
      </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <Link to="/tanks">
                        <button
                          type="button"
                          className="mt-3 w-full text-sm py-2 px-3 bg-destructive text-destructive-foreground rounded hover:bg-destructive/90 transition-colors"
                        >
                          Update Tank Level
                        </button>
                      </Link>
