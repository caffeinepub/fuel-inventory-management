...
export default function ShiftReport() {
  ...
  const sortedShifts = shifts.slice().sort((a, b) => Number(b.id) - Number(a.id));
                ...
                {sortedShifts.map((shift) => {
                  ...
                  return (
                    <TableRow key={shift.id.toString()}>
                      <TableCell className="font-medium whitespace-nowrap">#{shift.id.toString()}</TableCell>
                      <TableCell className="whitespace-nowrap">{getStaffName(shift.staffId)}</TableCell>
                      ...
                      <TableCell className="text-right whitespace-nowrap">₹{revenue.toFixed(2)}</TableCell>
                      <TableCell>
                  ...
                  <div className="pt-3 border-t">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm gap-2">
                        <span className="text-muted-foreground shrink-0">Petrol:</span>
                      ...
                      <div className="flex justify-between text-sm gap-2">
                        <span className="text-muted-foreground shrink-0">Diesel:</span>
                        <span className="font-medium text-right">
